...
# Optional dependencies used only for rich display / debugging
try:  # pragma: no cover
    import IPython.core.display as d  # type: ignore
...
from apt_cyber_sim.simulation.model import MachineStatus, PrivilegeLevel, PropertyName, VulnerabilityID, VulnerabilityType
from . import model
